...
---@class canola.RenameTransformOpts
---@field types? canola.EntryType[]
---@field bufnr? integer

---@param callback fun(name: string, entry: canola.Entry): nil|string
---@param opts? canola.RenameTransformOpts
...
M.transform = function(callback, opts)
  ...
  for i, line in ipairs(lines) do
    local result, parse_err = parser.parse_line(adapter, line, nil)
